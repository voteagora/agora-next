...
ARG NEXT_PUBLIC_AGORA_INFRA_ENV
ARG NEXT_PUBLIC_AGORA_CONTRACT_DEPLOYMENT
ARG DATABASE_URL
...
ENV NEXT_PUBLIC_AGORA_INFRA_ENV=$NEXT_PUBLIC_AGORA_INFRA_ENV
ENV NEXT_PUBLIC_AGORA_CONTRACT_DEPLOYMENT=$NEXT_PUBLIC_AGORA_CONTRACT_DEPLOYMENT
