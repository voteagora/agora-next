...
export default async function DAOMetricsHeader({ metrics }) {
  ...
  return (
    <div className="w-screen sm:min-w-desktop fixed bottom-0 left-0 flex justify-center">
      <div
        className={cn(
          "z-50 flex items-center w-full sm:w-[1268px] h-10 bg-gray-fa shadow-newDefault",
      ...
      >
        ...
        <div className="w-1/2 sm:w-1/5 flex justify-center items-center px-3 sm:px-8 gap-4">
          {/* TODO: discord logo and learn and help link and get active voters, and sticky or fixed only on y axis for ipad, investigate fixed in other parts of app */}
          <span>Learn</span>
          <span>Help</span>
          <a
