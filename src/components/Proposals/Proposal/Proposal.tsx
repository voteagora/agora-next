...
export default function Proposal({
  ...
  const snapshotLink = shouldNavigateToSnapshot
    ? (proposal.proposalData as ParsedProposalData["SNAPSHOT"]["kind"]).link
    : null;

  return snapshotLink ? (
    <a href={snapshotLink} target="_blank" rel="noreferrer noopener">
      <div
    ...
    <Link to={`/proposals/${proposal.id}` as never}>
      <div
        className="border-b border-line items-center flex flex-row bg-neutral"
        data-testid={`proposal-list-item-${proposal.id}`}
      >
