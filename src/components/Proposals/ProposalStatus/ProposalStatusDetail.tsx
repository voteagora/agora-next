      ...
      <div>
        {proposalStatus === "ACTIVE" && (
          <p
            ...
            className="text-blue-600 bg-sky-200 rounded-sm px-1 py-0.5 font-semibold"
          >
            ACTIVE
          </p>
        )}
        {proposalStatus === "QUEUED" && (
          <p
            data-testid="proposal-status-badge"
            className="text-blue-600 bg-blue-200 rounded-sm px-1 py-0.5 font-semibold"
          >
            QUEUED
          </p>
        )}
        {proposalStatus === "CLOSED" && (
          <p
            data-testid="proposal-status-badge"
            className="text-wash bg-tertiary rounded-sm px-1 py-0.5 font-semibold"
          >
            CLOSED
          </p>
        )}
        ...
        {proposalStatus === "DEFEATED" && (
          <p
            data-testid="proposal-status-badge"
            className="text-red-600 bg-red-200 rounded-sm px-1 py-0.5 font-semibold"
          >
            DEFEATED
          </p>
        )}
        {proposalStatus === "FAILED" && (
          <p
            data-testid="proposal-status-badge"
            className="text-gray-600 bg-gray-300 rounded-sm px-1 py-0.5 font-semibold"
          >
            FAILED
          </p>
        )}
