...
import TieredVetoThresholdIndicator from "./TieredVetoThresholdIndicator";
        ...
        <div className="border border-line rounded-xl mb-2 bg-neutral">
          ...
          {activeTab === "results" ? (
            <>
              ...
              <div className="flex-1 bg-white border-line mb-[196px]">
                <div
                  className="w-full rounded border border-line overflow-hidden mx-4 mt-4"
                  style={{ width: "calc(100% - 32px)" }}
                >
                  <TieredVetoThresholdIndicator proposal={proposal} />
                </div>
              </div>
