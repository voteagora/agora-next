...
function CastVoteWithReason({
  ...
  return (
    <VStack gap={4}>
      <textarea
        className="p-4 resize-none rounded-lg bg-theme-100 border-theme-300 transition-all"
      ...
      <div
        className={
          checked
            ...
            : "absolute right-0 top-1/2 -translate-y-1/2 rounded-sm w-4 h-4 flex items-center justify-center transition-all bg-theme-100 border-theme-300"
        }
      >
