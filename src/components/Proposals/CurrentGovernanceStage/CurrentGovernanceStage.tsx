...
export default function CurrentGovernanceStage({
  ...
  return (
    <div className="flex items-center justify-between bg-wash text-theme-700 text-xs px-6 pt-2 pb-6 -mb-5 border border-line border-b-0 rounded-tl-2xl rounded-tr-2xl">
