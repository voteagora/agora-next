  ...
  "inline-flex items-center justify-center whitespace-nowrap",
  {
    variants: {
      variant: {
        ...
        gray: "rounded-full py-1 px-3 text-secondary font-medium hover:bg-line hover:text-primary data-[state=active]:text-primary data-[state=active]:bg-line data-[state=active]:hover:bg-line",
