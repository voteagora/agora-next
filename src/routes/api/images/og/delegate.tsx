    ...
    handlers: {
      GET: async ({ request }: { request: Request }) => {
        ...
        const [interBoldFont, interRegularFont, bg] = await Promise.all([
          ...
          fetch(new URL(`${origin}/fonts/Inter/Inter-Regular.ttf`)).then((r) =>
            r.arrayBuffer()
          ),
          fetch(new URL(`${origin}/images/og-delegate-bg.png`)).then((r) =>
            r.arrayBuffer()
          ),
        ]);
                ...
                <div tw="flex w-[430px] ml-[97px] mt-[34px]">
                  <div tw="flex flex-col w-full">
                    <div tw="flex mb-[26px]">
                      <div tw="flex">
                        ...
                        <div tw="flex flex-col justify-center ml-[16px]">
                          ...
                          {votes && (
                            <div tw="flex text-[17px] text-primary">
                              {votes}
                            </div>
                          )}
                        </div>
                    ...
                    <div tw="flex flex-col h-full">
                      {statement && (
                        <div tw="flex text-2xl text-primary h-60">
                          {statement}
                        </div>
                      )}
                    </div>
