/*
 * TanStack Start port of src/app/api/v1/retrofunding/rounds/[roundId]/ballots/[ballotCasterAddressOrEns]/projects/[projectId]/allocation/[allocation]/route.ts.
 * URL: POST /api/v1/retrofunding/rounds/:roundId/ballots/:ballotCasterAddressOrEns/projects/:projectId/allocation/:allocation
 */
...
const allocationParser = z.string(z.number().min(0).max(100));

export const Route = createFileRoute(
  "/api/v1/retrofunding/rounds/$roundId/ballots/$ballotCasterAddressOrEns/projects/$projectId/allocation/$allocation"
)({
  server: {
    handlers: {
