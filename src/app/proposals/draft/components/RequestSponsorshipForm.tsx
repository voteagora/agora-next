...
import { onSubmitAction as requestSponsorshipAction } from "@/server/proposals/draft/requestSponsorship";
import AvatarAddress from "./AvatarAdress";
import { invalidatePath } from "@/server/proposals/draft/revalidatePath";
