...
import { fetchDraftProposal, getDraftProposalByUuid } from "@/app/api/common/draftProposals/getDraftProposals";
...
export default async function DraftProposalPage({
  ...
  // Fetch by UUID (or fallback to numeric if UUID not found)
