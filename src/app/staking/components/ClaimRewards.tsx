...
export const ClaimRewards = () => {
  ...
  return <div className="flex flex-col rounded-lg border border-gray-300 w-auto h-100 mb-4 p-5">
    <div className="flex flex-row gap-4 mb-4">
      ...
      <div>
        ...
        <div className="font-medium">{`${formatNumber(hasRewards ? data : 0,
          token.decimals,
        )} WETH`}</div>
      </div>
    </div>

    <Button variant="outline" disabled={!hasRewards}>Claim Rewards</Button>
  </div>;
