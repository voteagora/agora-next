...
const OgDunaDisclosures = () => {
  return (
    <div id="duna-administration" className="mt-8">
      ...
      >
        <div className="mb-6 font-medium">0G – DUNA DISCLOSURES</div>

        <div className="font-medium">
          <p className="mt-2">
            By owning the token and participating in the governance of 0g on
            this forum, you acknowledge and agree that you are electing to
...
export default OgDunaDisclosures;
