...
const sortValidator = createOptionalStringValidator(["most_delegators", "weighted_random"], DEFAULT_SORT);
const limitValidator = createOptionalNumberValidator(1, DEFAULT_MAX_LIMIT, DEFAULT_LIMIT);
