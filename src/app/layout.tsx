...
export default async function RootLayout({
  ...
  const style = {
    ...
    "--card-background-light": ui?.customization?.cardBackground || "255 255 255",
    "--card-background-dark": ui?.customization?.cardBackground || "30 26 47",
    "--hover-background-light": ui?.customization?.hoverBackground || "249 250 251",
    ...
    "--button-secondary-dark": ui?.customization?.buttonBackground || "25 16 62",
