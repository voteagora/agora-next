...
const StatCard = ({ className }: { className?: string }) => {
  return (
    <div
      className={`border border-agora-theme-100 bg-agora-theme-50 rounded-2xl flex flex-row ${className}`}
    >
      <span className="flex flex-1 flex-col items-center py-6 border-r border-agora-theme-100 last:border-0">
        <p className="text-xs text-agora-theme-700 font-medium">Total supply</p>
        <p className="font-semibold">2,000,000</p>
      </span>
      <span className="flex flex-1 flex-col items-center py-6 border-r border-agora-theme-100 last:border-0">
        <p className="text-xs text-agora-theme-700 font-medium">Airdrop 1</p>
        <p className="font-semibold">500,000</p>
      </span>
      <span className="flex flex-1 flex-col items-center py-6 border-r border-agora-theme-100 last:border-0">
        <p className="text-xs text-agora-theme-700 font-medium">
          Eligible addresses
        </p>
...
const EligibilityCriteriaItem = ({
  ...
  return (
    <div className="flex flex-row items-center py-4 border-b border-dotted last:border-solid border-agora-theme-100">
      {amount > 0 ? (
        <CheckCircleIcon className="h-5 w-5 text-green-500 mr-2" />
      ) : (
        <XCircleIcon className="h-5 w-5 text-agora-theme-700 mr-2" />
      )}
        ...
        <div className="bg-white rounded-2xl border border-agora-theme-100 p-6">
          ...
          <div className="mt-10">
            <div className="flex flex-row justify-between items-center">
              ...
              <span className="font-semibold text-xs text-agora-theme-700">
                Learn more
              </span>
            </div>
            <div>
      ...
      <section className="col-span-3">
        <div className="sticky top-4">
          <div className="bg-white rounded-2xl border border-agora-theme-100 p-6">
            ...
            <p className="text-agora-theme-700 mb-4">
              You are eligible for the airdrop
            </p>
            <div className="h-48 w-full border border-dotted border-agora-theme-100 rounded-2xl bg-[url('/images/receipt_bg.svg')] bg-center relative flex items-center justify-center">
