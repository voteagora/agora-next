    ...
    <main className="grid grid-cols-8 gap-10 mt-12">
      <section className="col-span-5">
        <div className="bg-white rounded-2xl border border-agora-theme-100 p-6">
          ...
          <p className="text-agora-theme-700 mt-10">
      ...
      <section className="col-span-3">
        <div className="bg-white rounded-2xl border border-agora-theme-100 p-6 sticky top-4">
          <h1 className="text-2xl font-black">Agree to Terms and Conditions</h1>
          <p className="text-agora-theme-700 mt-2">Please sign to continue</p>
          <div className="mt-10">
            <Button
              className="w-full"
              onClick={() => {
