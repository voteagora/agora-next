    ...
    <main className="h-[800px] w-full bg-[url('/images/scroll/scroll-claim-bg.png')] bg-contain bg-center flex items-center justify-center">
      <div className="relative w-[600px]">
        <div className="bg-white rounded-2xl border border-agora-stone-100 p-6 shadow-newDefault relative">
          ...
          <div className="mt-6 h-48 w-full border border-dotted border-agora-stone-100 rounded-2xl bg-[url('/images/receipt_bg.svg')] bg-center relative flex items-center justify-center">
        ...
        <footer className="px-6 pb-6 pt-12 bg-agora-stone-50 border border-agora-stone-100 rounded-b-2xl z-10 mt-[-24px]">
          <div className="flex flex-col">
            <span className="text-xs font-semibold text-agora-stone-500">
              Your voting power has been delegated
            </span>
            <div className="flex flex-row space-x-2 items-center mt-4">
              <span className="h-6 w-6 rounded-full bg-agora-stone-500"></span>
              <p>linda.eth</p>
              <span className="h-1 border-b border-dotted border-agora-stone-100 flex-1"></span>
              <span>est. 355</span>
            </div>
            <div className="flex flex-row space-x-2 items-center mt-4">
              <span className="h-6 w-6 rounded-full bg-agora-stone-500"></span>
