...
const PriorityCard = ({
  ...
  return (
    <div
      className={`${active ? "bg-agora-theme-50" : "bg-white"} flex flex-col py-4 border border-agora-theme-100 rounded-lg p-4 cursor-pointer`}
      onClick={onClick}
    >
      ...
      <span className="font-medium text-agora-theme-700">{description}</span>
    </div>
  );
};
    ...
    <main className="grid grid-cols-8 gap-10 mt-12">
      <section className="col-span-5">
        <div className="bg-white rounded-2xl border border-agora-theme-100 p-6">
          ...
          <p className="text-agora-theme-700 mt-4">
