...
export const demo4TenantConfig = ({
  isProd,
  alchemyId,
  ...
  const DAO_ID = isProd
    ? "0x0000000000000000000000000000000000000000"
    : "0x64656d6f342e0000000000000000000b00aa36a7";
  ...
  return {
    ...
    treasury: [],
    easRecipient: isProd ? "0x0000000000000000000000000000000000000000" : "0x64656d6f342e0000000000000000000b00aa36a7",
  };
};
