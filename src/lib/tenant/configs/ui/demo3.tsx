// Using demo assets as placeholder - replace with actual demo3 assets later
...
export const demo3TenantUIConfig = new TenantUI({
                    ...
                    <li>
                      ...
                      <ul className="list-[square] list-outside space-y-1 ml-6 mt-2 text-sm leading-relaxed">
                        ...
                        <li>
                          ...
                          the proposal or 10% of the TKN tokens in
