...
import type { NounsGovernor, NounsGovernorInterface } from "../NounsGovernor";
...
export class NounsGovernor__factory {
  static readonly abi = _abi;
  static createInterface(): NounsGovernorInterface {
    return new Interface(_abi) as NounsGovernorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): NounsGovernor {
    return new Contract(address, _abi, runner) as unknown as NounsGovernor;
  }
}
