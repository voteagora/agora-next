...
import type {
  AgoraGovernor_11,
  AgoraGovernor_11Interface,
} from "../AgoraGovernor_11";
...
const _abi = [
    ...
    outputs: [
      {
        name: "",
        type: "uint8",
        internalType: "enum AgoraGovernor.SupplyType",
      },
    ],
    stateMutability: "view",
  },
  ...
  {
    type: "error",
    name: "InvalidEmptyProposal",
    inputs: [],
  },
  {
    type: "error",
    name: "InvalidProposalExists",
    inputs: [],
  },
  {
    type: "error",
  ...
  {
    type: "error",
    name: "InvalidVotesBelowThreshold",
    inputs: [],
  },
  {
    type: "error",
...
export class AgoraGovernor_11__factory {
  static readonly abi = _abi;
  static createInterface(): AgoraGovernor_11Interface {
    return new Interface(_abi) as AgoraGovernor_11Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): AgoraGovernor_11 {
    return new Contract(address, _abi, runner) as unknown as AgoraGovernor_11;
  }
}
