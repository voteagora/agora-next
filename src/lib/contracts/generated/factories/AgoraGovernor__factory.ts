...
import type { AgoraGovernor, AgoraGovernorInterface } from "../AgoraGovernor";
...
export class AgoraGovernor__factory {
  static readonly abi = _abi;
  static createInterface(): AgoraGovernorInterface {
    return new Interface(_abi) as AgoraGovernorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): AgoraGovernor {
    return new Contract(address, _abi, runner) as unknown as AgoraGovernor;
  }
}
