...
import type { UniswapStaker, UniswapStakerInterface } from "../UniswapStaker";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "UniStaker__ExpiredDeadline",
    type: "error",
  },
  {
    inputs: [],
...
export class UniswapStaker__factory {
  static readonly abi = _abi;
  static createInterface(): UniswapStakerInterface {
    return new Interface(_abi) as UniswapStakerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): UniswapStaker {
    return new Contract(address, _abi, runner) as unknown as UniswapStaker;
  }
}
