...
import type {
  OptimismGovernor,
  OptimismGovernorInterface,
} from "../OptimismGovernor";
...
export class OptimismGovernor__factory {
  static readonly abi = _abi;
  static createInterface(): OptimismGovernorInterface {
    return new Interface(_abi) as OptimismGovernorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): OptimismGovernor {
    return new Contract(address, _abi, runner) as unknown as OptimismGovernor;
  }
}
