...
export interface AgoraGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "COUNTING_MODE"
...
export interface AgoraGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): AgoraGovernor;
  waitForDeployment(): Promise<this>;

  interface: AgoraGovernorInterface;
