...
export interface EtherfiTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface EtherfiToken extends BaseContract {
  connect(runner?: ContractRunner | null): EtherfiToken;
  waitForDeployment(): Promise<this>;

  interface: EtherfiTokenInterface;
