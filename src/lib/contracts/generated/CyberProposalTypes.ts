...
export interface CyberProposalTypesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "PERCENT_DIVISOR"
      | "governor"
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, BigNumberish, BigNumberish, string, AddressLike]
  ): string;
...
export interface CyberProposalTypes extends BaseContract {
  connect(runner?: ContractRunner | null): CyberProposalTypes;
  waitForDeployment(): Promise<this>;

  interface: CyberProposalTypesInterface;
  ...
  filters: {
    "ProposalTypeSet(uint8,uint16,uint16,string)": TypedContractEvent<
      ProposalTypeSetEvent.InputTuple,
      ProposalTypeSetEvent.OutputTuple,
      ProposalTypeSetEvent.OutputObject
    >;
