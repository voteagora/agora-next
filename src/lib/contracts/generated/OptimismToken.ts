...
export interface OptimismTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface OptimismToken extends BaseContract {
  connect(runner?: ContractRunner | null): OptimismToken;
  waitForDeployment(): Promise<this>;

  interface: OptimismTokenInterface;
