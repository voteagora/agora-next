...
export interface AgoraGovernor_11Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "COUNTING_MODE"
...
export namespace ProposalTypeUpdatedEvent {
  ...
  export type OutputTuple = [proposalId: bigint, proposalTypeId: bigint];
  export interface OutputObject {
    proposalId: bigint;
    proposalTypeId: bigint;
  }
...
export interface AgoraGovernor_11 extends BaseContract {
  connect(runner?: ContractRunner | null): AgoraGovernor_11;
  waitForDeployment(): Promise<this>;

  interface: AgoraGovernor_11Interface;
  ...
  SUPPLY_TYPE: TypedContractMethod<[], [bigint], "view">;
  ...
  editProposalType: TypedContractMethod<
    [proposalId: BigNumberish, proposalTypeId: BigNumberish],
    [void],
    "nonpayable"
  >;
