...
async function main() {
  for (const metric of metrics) {
    ...
    await prisma.metrics_data.upsert({
      where: {
      ...
      create: {
        ...
        url: `https://github.com/opensource-observer/oso/blob/main/warehouse/dbt/models/marts/superchain/metrics/rf4_${metric.metric_id}.sql`,
      },
      update: {
        name: metric.name,
        description: metric.description,
