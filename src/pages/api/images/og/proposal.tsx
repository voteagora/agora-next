      ...
      >
        <div tw="flex flex-col justify-between h-full px-16 pt-16 pb-22">
          ...
          <div tw="flex flex-row items-center">
            ...
            <svg tw="w-15 h-15" width="16" height="16" viewBox="0 0 16 16" fill="none"
            ...
            <div tw="bg-[#E0E0E0] w-2 h-3/4 mx-8"></div>
            <svg tw="w-15 h-15" width="1024" height="1024" viewBox="0 0 1024 1024" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
          ...
          <div tw="flex flex-col">
            <div tw="font-medium text-[42px] text-[#4F4F4F] mb-8">{title}</div>
            <div tw="font-black	text-[68px]">{description}</div>
          </div>
        </div>
      </div>
    ),
