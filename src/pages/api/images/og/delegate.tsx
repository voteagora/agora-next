          ...
          <div tw="flex w-1/2">
            <div tw="flex flex-col shadow-lg rounded-lg p-10 w-full">
              ...
              <div tw="flex flex-col h-full">
                <div tw="flex text-xl text-slate-800 h-60 truncate text-clip">{statement}</div>
                <div tw="flex border border-slate-300 justify-center rounded-lg p-5 w-full mt-6 w-auto">Delegate</div>
              </div>
            </div>
          </div>
        </div>
